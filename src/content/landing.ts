...
export const pricingContent = {
  ...
  sectionSubtitle: "One plan. Everything included. Built for Texas independent providers.",
  plans: [
    {
      name: "3-Month Bridge",
      price: "$60",
  ...
  additionalInfo: {
    updatePrice: "Additional update requests: $29 each",
    refundPolicy: "14-day money-back guarantee for Pro, only if no signed packet has been generated. Concierge is non-refundable once work starts.",
    refundLink: { label: "View refund policy →", href: "#refunds" },
  },
};

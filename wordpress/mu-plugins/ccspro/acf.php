    ...
    return array(
        array(
            ...
            'fields' => array(
                ...
                array(
                    'key' => 'field_homepage_message',
                    'label' => '',
                    'type' => 'message',
                    'message' => '<strong>Homepage-only sections</strong> - these fields power the current <code>/</code> homepage.',
                ),
                array(
                    'key' => 'field_homepage_pain_accordion',
                    'label' => 'Homepage Pain Point',
                    'type' => 'accordion',
                    'open' => 0,
                    'multi_expand' => 1,
                ),
                array('key' => 'field_homepage_pain_section_label', 'label' => 'Section Label', 'name' => 'homepage_pain_section_label', 'type' => 'text', 'default_value' => 'The Problem', 'wrapper' => array('width' => '30')),
                array('key' => 'field_homepage_pain_headline', 'label' => 'Headline', 'name' => 'homepage_pain_headline', 'type' => 'text', 'default_value' => "Credentialing hasn't changed. The paperwork still wins.", 'wrapper' => array('width' => '70')),
                array(
                    'key' => 'field_homepage_pain_cards',
                    'label' => 'Pain cards',
                    'name' => 'homepage_pain_cards',
                    'type' => 'repeater',
                    'layout' => 'block',
                    'button_label' => 'Add Card',
                    'sub_fields' => array(
                        array('key' => 'field_homepage_pain_card_icon', 'label' => 'Icon', 'name' => 'icon', 'type' => 'text', 'wrapper' => array('width' => '20')),
                        array('key' => 'field_homepage_pain_card_title', 'label' => 'Title', 'name' => 'title', 'type' => 'text', 'wrapper' => array('width' => '80')),
                        array('key' => 'field_homepage_pain_card_body', 'label' => 'Body', 'name' => 'body', 'type' => 'textarea', 'rows' => 2),
                    ),
                ),
                array('key' => 'field_homepage_pain_summary_text', 'label' => 'Summary Text', 'name' => 'homepage_pain_summary_text', 'type' => 'textarea', 'rows' => 3),
                array(
                    'key' => 'field_homepage_cta_a_accordion',
                    'label' => 'Homepage CTA Block A',
                    'type' => 'accordion',
                    'open' => 0,
                    'multi_expand' => 1,
                ),
                array('key' => 'field_homepage_cta_a_headline', 'label' => 'Headline', 'name' => 'homepage_cta_a_headline', 'type' => 'text'),
                array('key' => 'field_homepage_cta_a_subheadline', 'label' => 'Subheadline', 'name' => 'homepage_cta_a_subheadline', 'type' => 'text'),
                array('key' => 'field_homepage_cta_a_primary_label', 'label' => 'Primary CTA Label', 'name' => 'homepage_cta_a_primary_label', 'type' => 'text', 'wrapper' => array('width' => '50')),
                array('key' => 'field_homepage_cta_a_primary_href', 'label' => 'Primary CTA Href', 'name' => 'homepage_cta_a_primary_href', 'type' => 'text', 'wrapper' => array('width' => '50')),
                array('key' => 'field_homepage_cta_a_secondary_label', 'label' => 'Secondary CTA Label', 'name' => 'homepage_cta_a_secondary_label', 'type' => 'text', 'wrapper' => array('width' => '50')),
                array('key' => 'field_homepage_cta_a_secondary_href', 'label' => 'Secondary CTA Href', 'name' => 'homepage_cta_a_secondary_href', 'type' => 'text', 'wrapper' => array('width' => '50')),
                array('key' => 'field_homepage_cta_a_style', 'label' => 'Style', 'name' => 'homepage_cta_a_style', 'type' => 'select', 'choices' => array('indigo' => 'Indigo', 'emerald' => 'Emerald'), 'default_value' => 'indigo'),
                array(
                    'key' => 'field_homepage_cta_b_accordion',
                    'label' => 'Homepage CTA Block B',
                    'type' => 'accordion',
                    'open' => 0,
                    'multi_expand' => 1,
                ),
                array('key' => 'field_homepage_cta_b_headline', 'label' => 'Headline', 'name' => 'homepage_cta_b_headline', 'type' => 'text'),
                array('key' => 'field_homepage_cta_b_subheadline', 'label' => 'Subheadline', 'name' => 'homepage_cta_b_subheadline', 'type' => 'text'),
                array('key' => 'field_homepage_cta_b_primary_label', 'label' => 'Primary CTA Label', 'name' => 'homepage_cta_b_primary_label', 'type' => 'text', 'wrapper' => array('width' => '50')),
                array('key' => 'field_homepage_cta_b_primary_href', 'label' => 'Primary CTA Href', 'name' => 'homepage_cta_b_primary_href', 'type' => 'text', 'wrapper' => array('width' => '50')),
                array('key' => 'field_homepage_cta_b_secondary_label', 'label' => 'Secondary CTA Label', 'name' => 'homepage_cta_b_secondary_label', 'type' => 'text', 'wrapper' => array('width' => '50')),
                array('key' => 'field_homepage_cta_b_secondary_href', 'label' => 'Secondary CTA Href', 'name' => 'homepage_cta_b_secondary_href', 'type' => 'text', 'wrapper' => array('width' => '50')),
                array('key' => 'field_homepage_cta_b_style', 'label' => 'Style', 'name' => 'homepage_cta_b_style', 'type' => 'select', 'choices' => array('indigo' => 'Indigo', 'emerald' => 'Emerald'), 'default_value' => 'emerald'),
                array(
                ...
                array(
                    'key' => 'field_home_support_accordion',
                    'label' => 'Homepage Support Cards',
                    'type' => 'accordion',
                    'open' => 0,
                    'multi_expand' => 1,
                ),
                array('key' => 'field_home_support_headline', 'label' => 'Headline', 'name' => 'home_support_headline', 'type' => 'text', 'default_value' => "We're here when you need us"),
                array(
                    'key' => 'field_home_support_channels',
                    'label' => 'Channels',
                    'name' => 'home_support_channels',
                    'type' => 'repeater',
                    'layout' => 'block',
                    'button_label' => 'Add Channel',
                    'sub_fields' => array(
                        array('key' => 'field_home_support_channel_icon', 'label' => 'Icon', 'name' => 'icon', 'type' => 'text', 'wrapper' => array('width' => '20')),
                        array('key' => 'field_home_support_channel_title', 'label' => 'Title', 'name' => 'title', 'type' => 'text', 'wrapper' => array('width' => '40')),
                        array('key' => 'field_home_support_channel_link', 'label' => 'Link', 'name' => 'link', 'type' => 'text', 'wrapper' => array('width' => '40')),
                        array('key' => 'field_home_support_channel_description', 'label' => 'Description', 'name' => 'description', 'type' => 'textarea', 'rows' => 2),
                    ),
                ),
                // ----- Team -----
                array(
